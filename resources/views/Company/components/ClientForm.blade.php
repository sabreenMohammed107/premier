                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12" style="direction:rtl">
                                                    <div class="form-group">
                                                        ...
                                                        <input name="commercial_register" {{$disabled ?? ''}} value="{{$commercial_register ?? ''}}" type="text" class="form-control" placeholder="المسمي الوظيفي">
                                                    </div>
                                                    <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        <label class=""> رصيد العميل الحالي</label>
