        ...
        <div class="product-payment-inner-st res-mg-t-30 analysis-progrebar-ctn">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    ...
                                    <div id="dropzone1" class="pro-ad addcoursepro">
                                            <div class="row">
                                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12" style="direction:rtl">
                                                    ...
                                                    <input name="contact_person_mobile" tabindex="15" {{$disabled ?? ''}} value="{{$contact_person_mobile ?? ''}}" type="text" class="form-control" placeholder="موبيل للتواصل">
                                                    </div>
                                                    <div class="form-group">
                                                ...
                                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12" style="direction:rtl">
                                                    ...
                                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12" style="direction:rtl">
                                                        <div class="form-group">
                                                            <label class="alert alert-danger" style="color: red;"> في حالة المدين نضع الرصيد الافتتاحي سالبة -6000</label>
                                                        </div>
                                                        <div class="form-group">
                    ...
                    <a href="{{url('/Company/Clients')}}" class="btn btn-primary waves-effect waves-light mg-b-15">الغاء</a>
