        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="mg-b-23">
                    ...
                    <a href="{{url('/Invoices/Sales')}}" class="btn btn-primary waves-effect waves-light">{{ __('titles.cancel') }}</a>
                ...
                <div class="sparkline13-list">
                    ...
                    <div class="sparkline13-graph">
                        ...
                        <div class="chosen-select-single mg-b-20 dir-rtl">
                                        ...
                                        <div class="row row-ltr">
                                            <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8">
                                                ...
                                                <select data-width="100%" id="person_id" name="person_id" class="selectpicker pperson" data-live-search="true" tabindex="-1">
                                                    <option disabled selected>{{__('titles.select')}}</option>
                                            ...
                                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                                                <div class="bt-df-checkbox">
                                                    <input class="radio-checked" type="radio" checked="" value="100" id="optionsRadios1 person_type_id" name="person">
                            ...
                            <div ><input type="text" id="search" class="form-control" style="display: inline-block;width:200px" placeholder="{{__('titles.search')}}">
