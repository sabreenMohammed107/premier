...
<div class="data-table-area mg-b-15">
    <div class="container-fluid">
        <div class="mg-b-15">
            <a href="{{ url("/Invoices/Purchasing/Add")}}" class="btn btn-primary waves-effect waves-light">{{ __('titles.add') }}</a>
        </div>
        <div class="row">
                ...
                <div class="sparkline13-list">
                    <div class="sparkline13-hd">
                        <div class="main-sparkline13-hd">
                            <h1 class="dir-rtl">{{ __('titles.purchases') }}</h1>
                        </div>
                    </div>
                    <div class="sparkline13-graph">
                        <div class="datatable-dashv1-list custom-datatable-overright dir-rtl" >
                            ...
                            <table class="table-striped dir-rtl" id="table"
                                    data-toggle="table"
			...
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<div class="modal-body">
						...
						<h4>{{ __('titles.delete_data_qest') }} {{$InvoiceModal->invoice_no}} ؟  </h4>
					</div>
					<div class="modal-footer info-md">
						<a data-dismiss="modal" href="#">{{ __('titles.cancel') }}</a>
                    <a href="{{url("/Invoices/Purchasing/$InvoiceModal->id/Delete")}}">{{ __('titles.delete') }}</a>
					</div>
				</div>
			</div>
		</div>
