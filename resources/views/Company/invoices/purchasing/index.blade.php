                                    ...
                                    @endphp
                                       ...
                                       <td>{{$i}}</td>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ url("/Invoices/Purchasing/$Invoice->id/View")}}" title="View" class="pd-setting-ed"><i class="fa fa-file" aria-hidden="true"></i></ش>
                                                <a href="{{ url("/Invoices/Purchasing/$Invoice->id/Edit")}}" title="Edit" class="pd-setting-ed"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
