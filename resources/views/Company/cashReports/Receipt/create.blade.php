...
<ul class="breadcome-menu">
    ...
    <li>
        <span class="bread-blod"> تقرير المقبوضات النقدية  </span>
    </li>
</ul>
                ...
                <div class="sparkline13-list">
                    <div class="sparkline13-hd">
                        <div class="main-sparkline13-hd">
                            <h4 style="text-align:right">تقرير المقبوضات النقدية </h4>
                        </div>
                    </div>
                    <div class="sparkline13-graph">
                        <div class="datatable-dashv1-list custom-datatable-overright" style="direction:rtl">
                            <div class="chosen-select-single mg-b-20" style="direction:rtl;">
                                <button type="submit" class="btn btn-primary waves-effect waves-light">عرض تقرير صفحات</button>
                            </div>
                                ...
                                <div class="row" style="text-align:right !important;direction:rtl !important">
                                    ...
                                    <div class="col-lg-7 col-md-7 col-sm-12 col-xs-12 shadow">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                                                <label class="login2">إذن إستلام</label>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8">
