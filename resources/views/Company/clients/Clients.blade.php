							...
							<thead>
                                ...
                                <td>
                                    <div class="product-buttons">
                                        <a href="{{ url("/Company/Clients/$Client->id/View")}}" title="View" class="pd-setting-ed"><i class="fa fa-file" aria-hidden="true"></i></a>
                                        <a href="{{ url("/Company/Clients/$Client->id/Edit")}}" title="Edit" class="pd-setting-ed"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
