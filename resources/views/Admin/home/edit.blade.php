                                                ...
                                                <div class="row">
                                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12" style="direction:rtl">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input name="company_official_name" value="{{$row->company_official_name}}" type="text" class="form-control" placeholder="الاسم بالكامل">
                                                        </div>
                                                        <div class="form-group">
                                                    ...
                                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12" style="direction:rtl">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input name="registeration_no" value="{{$row->registeration_no}}" type="text" class="form-control" placeholder="رقم التسجيل">
                                                        </div>
                                                        <div class="form-group">
