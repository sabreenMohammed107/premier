...
<ul class="breadcome-menu">
    ...
    <li>
        <span class="bread-blod"> {{ __('titles.supplier_transactions_reports') }}</span>
    </li>
</ul>
                ...
                <div class="sparkline13-list">
                    <div class="sparkline13-hd">
                        <div class="main-sparkline13-hd">
                            <h1 > {{ __('titles.supplier_transactions_reports') }}</h1><br />
                        </div>
                    </div>
                    <div class="sparkline13-graph">
                        ...
                        <div class="datatable-dashv1-list custom-datatable-overright">
                            <form action="@if(Auth::user()->role_id == 100 || Auth::user()->role_id == 101 || Auth::user()->role_id == 110){{route('Admin-supplier-report.store')}}
                            @else {{route('Company-supplier-report.store')}}@endif" method="post" target="_blank">
...
<script>
    $(document).ready(function() {
        ...
        $('select[name="select_company"]').on('change', function() {
            ...
            $.ajax({
                url: "@if(Auth::user()->role_id == 100 || Auth::user()->role_id == 101 || Auth::user()->role_id == 110){{route('dynamicCompany-supplierReport.fetch')}}@else{{route('Company-dynamicCompany-supplierReport.fetch')}}@endif",
                method: "get",
                data: {
                    company_id: company,
