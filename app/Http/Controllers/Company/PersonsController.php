...
class PersonsController extends Controller
{
    ...
    */
    ...
    public function Employees()
    {
        ...
        ->groupBy('active','person_logo','persons.person_name','total_pay','total_rec','persons.id','phone1','persons.open_balance')
        ->get();
        // return $Employees;
    ...
    public function EmployeesData(int $id, string $type)
    {
        ...
        ->leftjoin('person_types','person_types.id','=','persons.person_type_id')
        ->groupBy('active','persons.notes','person_nick_name','phone2','address','tax_authority','email','balance_start_date','persons.registeration_no','person_logo','persons.person_name','total_pay','total_rec','persons.id','phone1','persons.open_balance')
        ->first();
        return view('Company.employees.Employee-all',[
            'type'=>$type,
            'id'=>$id,
